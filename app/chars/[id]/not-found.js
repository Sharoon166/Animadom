...
const notf = () => {
  return (
    <div className="flex justify-center flex-col gap-4 items-center ">
      ...
      />
      <h2 className="text-yellow-500 p-8 flex justify-center items-center gap-2 text-2xl ">Kore character Exists Jenai (Its a free API so it has its limitations 💀)</h2>
